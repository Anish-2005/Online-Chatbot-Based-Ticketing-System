...
const colorSets = [
  {
    surface: 'from-violet-500/10 to-violet-600/10',
    badge: 'from-violet-500 to-violet-600',
    icon: 'bg-violet-100 text-violet-600 dark:bg-violet-900/30 dark:text-violet-400',
    button: 'from-violet-500 to-violet-600 hover:shadow-violet-500/50',
    bottom: 'from-violet-500 to-violet-600',
  },
  {
      ...
      <div className="flex-1 p-8 transition-all duration-300" style={{ marginLeft: 'var(--admin-sidebar-width, 16rem)' }}>
        ...
        >
          ...
          <button
            type="submit"
            disabled={saving}
            className="mt-4 rounded-xl bg-gradient-to-r from-indigo-600 to-blue-600 px-6 py-3 text-sm font-semibold text-white transition-all hover:scale-105 disabled:opacity-60"
          >
