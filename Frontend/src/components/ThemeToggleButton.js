    ...
    return (
        <motion.button
            ...
            className={`relative inline-flex items-center justify-center overflow-hidden rounded-xl font-semibold shadow-lg transition-all duration-300 ${isCollapsed ? 'w-10 h-10 p-0' : 'px-4 py-2.5 min-w-[140px]'
                    ...
                    ? 'bg-gradient-to-br from-indigo-900 via-purple-900 to-gray-900 text-yellow-300 border border-purple-700/50 hover:border-purple-500 hover:shadow-purple-900/50'
        ...
        >
            ...
            <div className={`absolute inset-0 opacity-20 transition-opacity duration-300 group-hover:opacity-100 ${isDark ? 'bg-purple-500 blur-xl' : 'bg-orange-400 blur-xl'
                }`} />
