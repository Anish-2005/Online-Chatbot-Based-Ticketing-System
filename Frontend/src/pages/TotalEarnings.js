...
const colorSets = [
  ...
  { bg: 'bg-blue-100 dark:bg-blue-900/20', text: 'text-blue-600 dark:text-blue-400', chip: 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300', fill: '#DB2777' },
