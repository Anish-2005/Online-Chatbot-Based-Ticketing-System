...
const StatItem = ({ value, suffix = '', label }) => {
  ...
  return (
    <div className="text-center">
      <div className="text-4xl sm:text-5xl font-heading font-black bg-gradient-to-r from-violet-600 to-indigo-600 dark:from-violet-400 dark:to-indigo-400 bg-clip-text text-transparent">
...
const FloatingOrbs = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
    <div className="absolute -top-[20%] -right-[10%] w-[500px] h-[500px] rounded-full bg-violet-500/10 dark:bg-violet-500/5 blur-[100px] animate-float" />
    <div className="absolute -bottom-[20%] -left-[10%] w-[450px] h-[450px] rounded-full bg-indigo-500/10 dark:bg-indigo-500/5 blur-[100px] animate-float-delayed" />
    <div className="absolute top-[40%] left-[30%] w-[300px] h-[300px] rounded-full bg-indigo-500/5 dark:bg-indigo-500/3 blur-[80px] animate-float-slow" />
  </div>
);
    ...
    <div className={`min-h-screen w-full ${isDark ? 'dark bg-gray-950' : 'bg-white'} overflow-hidden`}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-50 dark:bg-violet-900/30 border border-violet-200 dark:border-violet-700/50"
              >
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-heading font-black leading-[1.08] tracking-tight">
                <span className="bg-gradient-to-r from-violet-600 via-indigo-600 to-blue-500 dark:from-violet-400 dark:via-indigo-400 dark:to-blue-400 bg-clip-text text-transparent">
                  Experience
                </span>
                <br />
            ...
            >
              {/* Background glow */}
              <div className="absolute inset-0 bg-gradient-to-br from-violet-500/20 to-indigo-500/20 rounded-[3rem] blur-3xl" />
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-5">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-bold uppercase tracking-wider text-violet-600 dark:text-violet-400">E-Ticket</p>
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-5">
                    {[
                      ...
                      <div
                        key={item.label}
                        className={`rounded-xl p-3 text-center ${isDark ? 'bg-gray-700/50' : 'bg-violet-50'
                          }`}
                      >
      ...
      <section className={`py-24 ${isDark ? 'bg-gray-950' : 'bg-white'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <span className="badge badge-violet mb-4">Features</span>
          ...
          >
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="group flex items-center justify-center gap-3 px-8 py-4 rounded-2xl font-heading font-bold text-lg bg-white text-violet-700 shadow-xl hover:shadow-2xl transition-all"
              >
                Start Booking
                <FaArrowRight className="group-hover:translate-x-1 transition-transform" />
              </motion.button>
